...
import com.meterial.demo.customview.Chameleon;

/**
 * TODO
 *https://github.com/woxingxiao/Chameleon
 * @author zenghao
 * @since 2017/7/4 下午4:53
 */
public class ChameleonActivity extends AppCompatActivity implements View.OnClickListener {

    private static final int[] IMAGES = {
            R.mipmap.landscape_1, R.mipmap.landscape_2,
    ...
    private class MyPagerAdapter extends PagerAdapter {
        ...
        MyPagerAdapter() {
            for (int i = 0; i < mImageViews.length; i++) {
                mImageViews[i] = new ImageView(ChameleonActivity.this);

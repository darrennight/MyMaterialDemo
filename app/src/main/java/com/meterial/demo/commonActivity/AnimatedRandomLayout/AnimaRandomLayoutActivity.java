package com.meterial.demo.commonActivity.AnimatedRandomLayout;
...
public class AnimaRandomLayoutActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_anim_random_layout);

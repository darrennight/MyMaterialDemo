package com.meterial.demo.commonActivity.cardview;
...
public class TestCenterDrawable extends Drawable {
    Paint paint;
    Paint paintShadow;
    Paint paintLine;
    Path path;
    ...
    public TestCenterDrawable(Bitmap bitmap) {
    ...
    public void draw(Canvas canvas) {
        ...
        //画一半虚线 
        canvas.drawLine(getBounds().bottom*0.8f, getBounds().bottom/2, (getBounds().right  - getBounds().bottom * 0.8f), getBounds().bottom/2, paintLine);

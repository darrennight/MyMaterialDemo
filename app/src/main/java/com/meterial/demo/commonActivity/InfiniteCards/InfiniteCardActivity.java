 ...
 */
public class InfiniteCardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCardView.setCardAnimationListener(new InfiniteCardView.CardAnimationListener() {
            ...
            public void onAnimationStart() { 
                Toast.makeText(InfiniteCardActivity.this, "Animation Start", Toast.LENGTH_SHORT).show();
            } 
 
            @Override 
            public void onAnimationEnd() { 
                Toast.makeText(InfiniteCardActivity.this, "Animation End", Toast.LENGTH_SHORT).show();
            } 
        }); 
        initButton(); 
    } 

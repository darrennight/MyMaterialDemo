...
import com.meterial.demo.customview.AnimTextView;

import java.util.Random;

import cn.dreamtobe.percentsmoothhandler.ISmoothTarget;

public class MagicProgressBarActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_magic_progress);
        assignViews();

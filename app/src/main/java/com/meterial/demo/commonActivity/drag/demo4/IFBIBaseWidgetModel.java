...
public class IFBIBaseWidgetModel { 
    ...
    private JSONObject createViewObject() throws JSONException {
        ...
        putToView(view, Constant.REGION.DIMENSION1, mDimension1.toViewArray());
        putToView(view, Constant.REGION.DIMENSION2, mDimension2.toViewArray());
        putToView(view, Constant.REGION.TARGET1, mTarget1.toViewArray());
        putToView(view, Constant.REGION.TARGET2, mTarget2.toViewArray());
        putToView(view, Constant.REGION.TARGET3, mTarget3.toViewArray());
        return view;
    } 
    ...
    private void parseDimensions(JSONObject view, JSONObject dimensions) {
        ...
        parseDimensionsToList(view.optJSONArray(Constant.REGION.DIMENSION1), mDimension1);
        parseDimensionsToList(view.optJSONArray(Constant.REGION.DIMENSION2), mDimension2);
        parseDimensionsToList(view.optJSONArray(Constant.REGION.TARGET1), mTarget1);
        parseDimensionsToList(view.optJSONArray(Constant.REGION.TARGET2), mTarget2);
        parseDimensionsToList(view.optJSONArray(Constant.REGION.TARGET3), mTarget3);

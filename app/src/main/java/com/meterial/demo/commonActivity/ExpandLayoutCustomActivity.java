...
import com.meterial.demo.customview.ExpandableLinearLayout;

/**
 * TODO
 *https://github.com/chaychan/PowerfulViewLibrary
 * @author zenghao
 * @since 2017/7/31 下午6:11
 */
public class ExpandLayoutCustomActivity extends AppCompatActivity {
    ...
    class ViewHolder {
        ...
        private void refreshUI() {
            Glide.with(ExpandLayoutCustomActivity.this)

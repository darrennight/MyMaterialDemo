...
public class DemoFragment extends Fragment{
    ...
    private int[] pic1 = new int[]{
            R.mipmap.svg_new_close, R.mipmap.svg_new_home, R.mipmap.offered_exit,
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_demo_remote, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mAdapter.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                ((RemoteActivity) getActivity()).setDragInfo(mAdapter.getItem(position));
                return false;
            }
        });
    }

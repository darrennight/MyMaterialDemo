...
public class DetailedChipView extends RelativeLayout {
    ...
    // xml elements 
    @BindView(R.id.content) RelativeLayout mContentLayout;
    @BindView(R.id.avatar_icon) CircleImageView mAvatarIconImageView;
    @BindView(R.id.name) TextView mNameTextView;
    @BindView(R.id.info) TextView mInfoTextView;

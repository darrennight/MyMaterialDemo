 ...
 *
 * @author zenghao
 * @since 17/3/17 下午4:56
 */
public class WheelActivity1 extends AppCompatActivity implements CursorWheelLayout.OnMenuSelectedListener {
    ...
    private void initData() {
        ...
        mTestCircleMenuTop.setOnMenuSelectedListener(new CursorWheelLayout.OnMenuSelectedListener() {
            ...
            public void onItemSelected(CursorWheelLayout parent, View view, int pos) {
                Toast.makeText(WheelActivity1.this, "Top Menu selected position:" + pos, Toast.LENGTH_SHORT).show();
            }
        });
        mTestCircleMenuTop.setOnMenuItemClickListener(new CursorWheelLayout.OnMenuItemClickListener() {
            @Override
            public void onItemClick(View view, int pos) {
                Toast.makeText(WheelActivity1.this, "Top Menu click position:" + pos, Toast.LENGTH_SHORT).show();

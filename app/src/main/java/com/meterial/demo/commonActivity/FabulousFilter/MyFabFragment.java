...
public class MyFabFragment extends AAH_FabulousFragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        applied_filters = ((FabulousFilterActivity)getActivity()).getApplied_filters();
...
//            ll_scroll.setLayoutParams(lp);
    ...
    private void inflateLayoutWithFilters(final String filter_category, FlexboxLayout fbl) {
        ...
        switch (filter_category) {
            case "genre":
                keys = ((FabulousFilterActivity) getActivity()).getmData().getUniqueGenreKeys();
                break;
            case "rating":
                keys = ((FabulousFilterActivity) getActivity()).getmData().getUniqueRatingKeys();
                break;
            case "year":
                keys = ((FabulousFilterActivity) getActivity()).getmData().getUniqueYearKeys();
                break;
            case "quality":
                keys = ((FabulousFilterActivity) getActivity()).getmData().getUniqueQualityKeys();
                break;
        }

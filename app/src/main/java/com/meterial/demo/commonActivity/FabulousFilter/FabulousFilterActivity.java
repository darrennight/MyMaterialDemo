 ...
 * @author zenghao
 * @since 2017/7/4 下午6:09
 */
public class FabulousFilterActivity extends AppCompatActivity implements AAH_FabulousFragment.Callbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fabulous_filter);
        ...
        mAdapter = new MoviesAdapter(mList, p, FabulousFilterActivity.this);

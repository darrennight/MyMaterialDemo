package com.meterial.demo.commonActivity.WaveView;
...
/**
 * 双波纹水波进度条  颜色分离字体效果
 * Created by xunlei on 2017/2/26.
 */

public class WaveProgressTest extends View {

    private static final String TAG = WaveProgressTest.class.getSimpleName();
    ...
    private int mWidth = MiscUtil.dipToPx(getContext(), 50);
    private int mHeight = MiscUtil.dipToPx(getContext(), 50);
    private int textSize = MiscUtil.dipToPx(getContext(), 10);
    ...
    public WaveProgressTest(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        Log.d(TAG, "onSizeChanged: w = " + w + "; h = " + h + "; oldw = " + oldw + "; oldh = " + oldh + "time=========" + System.currentTimeMillis());
...
//		bitmap.eraseColor(Color.parseColor("#FF0000"));//填充颜色
    ...
    private void startDarkWaveAnimator() {
        ...
        mDarkWaveAnimator = ValueAnimator.ofFloat(0, 1);
        ...
        mDarkWaveAnimator.setRepeatMode(ValueAnimator.RESTART);

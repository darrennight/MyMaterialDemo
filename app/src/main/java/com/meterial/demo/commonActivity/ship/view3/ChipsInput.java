...
public class ChipsInput extends ScrollViewMaxHeight {
    ...
    // xml element
    @BindView(R.id.chips_recycler) RecyclerView mRecyclerView;
    // adapter
    ...
    private void init(AttributeSet attrs) {
        ...
        if(attrs != null) {
            ...
            try {
                // hint
                mHint = a.getString(R.styleable.ChipsInput_hintChip);
                mHintColor = a.getColorStateList(R.styleable.ChipsInput_hintColor);
                mTextColor = a.getColorStateList(R.styleable.ChipsInput_shiptextColor);

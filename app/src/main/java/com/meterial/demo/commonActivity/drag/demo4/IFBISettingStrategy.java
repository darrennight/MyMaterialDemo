...
import static com.meterial.demo.commonActivity.drag.demo4.Constant.TEXT_COLOR_BLUE;
...
public abstract class IFBISettingStrategy {
    ...
    private void initRegions() {
        ...
        region1 = new IFBISettingRegion(Constant.REGION.DIMENSION1);
        region2 = new IFBISettingRegion(Constant.REGION.DIMENSION2);
        region3 = new IFBISettingRegion(Constant.REGION.TARGET1);
        region4 = new IFBISettingRegion(Constant.REGION.TARGET2);
        region5 = new IFBISettingRegion(Constant.REGION.TARGET3);

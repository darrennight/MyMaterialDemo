package com.meterial.demo.commonActivity.scaleImg;
...
/**
 * TODO
 *https://github.com/woxingxiao/ScaleTransitionAnim
 * @author zenghao
 * @since 2017/7/4 下午5:12
 */
public class ScaleTransitionImageAnim extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scaletransitionanim);
        ...
        mRecyclerView.setAdapter(new BaseQuickAdapter<String>(R.layout.item_pic_thumb, urls) {
            ...
            protected void convert(final BaseViewHolder holder, final String url) {
                ...
                Glide.with(ScaleTransitionImageAnim.this)
                        .load(url)
                        .into(thumbView);
            }
        });
        ...
        mRecyclerView.addOnItemTouchListener(new OnItemClickListener() {
            ...
            public void SimpleOnItemClick(BaseQuickAdapter baseQuickAdapter, View view, int position) {
                mPreviewLayout = new PreviewLayout(ScaleTransitionImageAnim.this);

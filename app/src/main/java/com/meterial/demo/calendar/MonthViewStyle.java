...
public class MonthViewStyle extends View {

    public interface OnDayClickListener {
        void onDayClick(MonthViewStyle monthView, CalendarDayModel day);
    }
    ...
    public MonthViewStyle(Context context) {
        super(context);
        init(null);
    }

    public MonthViewStyle(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public MonthViewStyle(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void drawMonthDay(Canvas canvas) {
        ...
        for (int i = 0; i < days.size(); i++) {
            ...
            if (!day.isToday) {
                ...
                todayCirclePaint.setColor(Color.BLACK);
                ...
                canvas.drawCircle(w + getPaddingLeft()+todayCircleRadius*3, h + itemWidth / 4 + this.todayCircleRadius * 2,
                        ((float) this.todayCircleRadius), this.todayCirclePaint);

                canvas.drawCircle(w + getPaddingLeft()+todayCircleRadius*6, h + itemWidth / 4 + this.todayCircleRadius * 2,
                        ((float) this.todayCircleRadius), this.todayCirclePaint);
            }
            dayOffset++;
            if (dayOffset == 7) {

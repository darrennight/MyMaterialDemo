...
public class MonthViewThum extends View {

    public interface OnDayClickListener {
        void onDayClick(MonthViewThum monthView, CalendarDayModel day);
    }
    ...
    public MonthViewThum(Context context) {
        super(context);
        init(null);
    }

    public MonthViewThum(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public MonthViewThum(Context context, AttributeSet attrs, int defStyleAttr) {
            ...
            if (day.isUnavailable) {
                ...
                if (day.isBetweenStartAndEndSelected) {
                    ...
                    if (mCalendarMonthModel.hasSelectedStartAndEnd()) {
                        ...
                        canvas.drawRect(left, top, right, (bottom+top)/2, selectedCirclePaint);
                    }
                }
            }
            //绘制文本day

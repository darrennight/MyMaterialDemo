...
public class CalendarPickerView extends ListView {
  ...
  public CalendarPickerView(Context context, AttributeSet attrs) {
    ...
    TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.SquareCalendarPickerView);
    final int bg = a.getColor(R.styleable.SquareCalendarPickerView_android_background,
        res.getColor(R.color.calendar_bg));
    dividerColor = a.getColor(R.styleable.SquareCalendarPickerView_timesquare_dividerColor,
        res.getColor(R.color.calendar_divider));
    dayBackgroundResId = a.getResourceId(R.styleable.SquareCalendarPickerView_timesquare_dayBackground,
        R.drawable.calendar_bg_selector);
    dayTextColorResId = a.getResourceId(R.styleable.SquareCalendarPickerView_timesquare_dayTextColor,
        R.color.calendar_text_selector);
    titleTextStyle = a.getResourceId(R.styleable.SquareCalendarPickerView_timesquare_titleTextStyle,
        R.style.SquareCalendarTitle);
    displayHeader = a.getBoolean(R.styleable.SquareCalendarPickerView_timesquare_displayHeader, true);
    headerTextColor = a.getColor(R.styleable.SquareCalendarPickerView_timesquare_headerTextColor,
        res.getColor(R.color.calendar_text_active));
    displayDayNamesHeaderRow =
            a.getBoolean(R.styleable.SquareCalendarPickerView_timesquare_displayDayNamesHeaderRow, true);
    displayAlwaysDigitNumbers =
            a.getBoolean(R.styleable.SquareCalendarPickerView_timesquare_displayAlwaysDigitNumbers, false);
    a.recycle();

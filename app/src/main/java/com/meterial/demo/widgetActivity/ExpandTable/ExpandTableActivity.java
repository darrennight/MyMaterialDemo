...
public class ExpandTableActivity extends Activity implements ExpandGridAdapter.OnClick {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_expand_table);
        initData();
        initView();
    }
    ...
    public class OnItemClick implements OnClickListener, OnPageChangeListener {
        ...
        private void init(View v, int location) {
            ...
            // View的 初始化
            for (int n = 1; n <= i; n++) {
                View view = LayoutInflater.from(ExpandTableActivity.this).inflate(R.layout.viewpager, null);
                ...
                ExpandGridAdapter ea = new ExpandGridAdapter(ExpandTableActivity.this, list, R.layout.expand_grid_item);
            ...
            // 宽度每一个格高度 42dp 转成px
            int height = (int) (ExpandTableActivity.this.getResources().getDisplayMetrics().density * 42 + 0.5f);

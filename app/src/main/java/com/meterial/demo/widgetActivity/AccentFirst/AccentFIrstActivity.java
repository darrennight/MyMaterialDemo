package com.meterial.demo.widgetActivity.AccentFirst;
 ...
 */
public class AccentFIrstActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_accent_first);

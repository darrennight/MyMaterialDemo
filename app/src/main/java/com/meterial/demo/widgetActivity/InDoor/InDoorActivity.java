...
public class InDoorActivity extends AppCompatActivity {
    ...
    private static class NewHandler extends Handler {
        private WeakReference<InDoorActivity> weakReference;

        public NewHandler(InDoorActivity main) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        view.setOnClickMapListener(new InDoorView.onClickMapListener() {
            ...
            public void onClick(PathUnit region) {
                ...
                AlertDialog.Builder dialog = new AlertDialog.Builder(InDoorActivity.this);

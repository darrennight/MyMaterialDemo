 ...
 */
public class MyNewPhotoView extends AppCompatImageView {
    ...
    public MyNewPhotoView(Context context) {
        super(context);
        init();
    }

    public MyNewPhotoView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public MyNewPhotoView(Context context, AttributeSet attrs, int defStyleAttr) {
...
//            mScaleCenter.set(detector.getFocusX(), detector.getFocusY());
    ...
    private Runnable mClickRunnable = new Runnable() {
        ...
        public void run() {
            if (mClickListener != null) {
                mClickListener.onClick(MyNewPhotoView.this);
            }
        }
    };
    ...
    private GestureDetector.OnGestureListener mGestureListener = new GestureDetector.SimpleOnGestureListener() {
        ...
        public void onLongPress(MotionEvent e) {
            if (mLongClick != null) {
                mLongClick.onLongClick(MyNewPhotoView.this);
            }
        }

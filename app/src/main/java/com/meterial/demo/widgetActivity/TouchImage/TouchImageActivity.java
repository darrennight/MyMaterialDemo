package com.meterial.demo.widgetActivity.TouchImage;
...
/**
 * https://github.com/RrtoyewxXu/AndTouchImage
 */
public class TouchImageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_touch_image);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu_main_touch, menu);
        return true;
    }

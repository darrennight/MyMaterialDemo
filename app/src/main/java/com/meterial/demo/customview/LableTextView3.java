 ...
 *
 * @author zenghao
 * @since 2018/5/7 下午3:23
 */
public class LableTextView3 extends ViewGroup {
    //单行显示
    ...
    public LableTextView3(Context context) {
        super(context);
    }

    public LableTextView3(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public LableTextView3(Context context, AttributeSet attrs, int defStyleAttr) {

 ...
 */
public class RoundBg extends RelativeLayout {
    ...
    public RoundBg(Context context) {
        this(context,null,0);
    }

    public RoundBg(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public RoundBg(Context context, AttributeSet attrs, int defStyleAttr) {

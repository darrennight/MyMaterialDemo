...
public class StaggeredGridActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_grid_anim);
    ...
    private List<StaggeredGridAdapter.Items> mockData() {
        ...
        dataList.add(new StaggeredGridAdapter.Items("flower", R.drawable.image_0002));
        dataList.add(new StaggeredGridAdapter.Items("flower", R.drawable.image_0003));
        dataList.add(new StaggeredGridAdapter.Items("flower", R.drawable.image_0838));
        dataList.add(new StaggeredGridAdapter.Items("flower", R.drawable.image_1107));
        dataList.add(new StaggeredGridAdapter.Items("flower", R.drawable.image_0005));
        dataList.add(new StaggeredGridAdapter.Items("flower", R.drawable.image_1118));
        dataList.add(new StaggeredGridAdapter.Items("flower", R.drawable.image_0007));
        dataList.add(new StaggeredGridAdapter.Items("flower", R.drawable.image_1150));
        dataList.add(new StaggeredGridAdapter.Items("flower", R.drawable.image_0009));
        dataList.add(new StaggeredGridAdapter.Items("flower", R.drawable.image_1281));
        dataList.add(new StaggeredGridAdapter.Items("flower", R.drawable.image_0011));
        dataList.add(new StaggeredGridAdapter.Items("flower", R.drawable.image_1293));
        dataList.add(new StaggeredGridAdapter.Items("flower", R.drawable.image_1342));
        dataList.add(new StaggeredGridAdapter.Items("flower", R.drawable.image_1351));
        dataList.add(new StaggeredGridAdapter.Items("flower", R.drawable.image_0015));
        for (int i = 0; i < dataList.size(); i++) {
            StaggeredGridAdapter.Items items = dataList.get(i);

package com.meterial.demo.chart.piechart;
...
//        setLayerType(View.LAYER_TYPE_SOFTWARE, null);
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.ChartPieChart, defStyleAttr,defStyleRes);
        int n = array.getIndexCount();
        for (int i=0; i<n; i++){
            int attr = array.getIndex(i);
            switch (attr){
                case R.styleable.ChartPieChart_name:
                    name = array.getString(attr);
                    break;
                case R.styleable.ChartPieChart_percentDecimal:
                    percentDecimal = array.getInt(attr,percentDecimal);
                    break;
                case R.styleable.ChartPieChart_charttextSize:

package com.meterial.demo.FragmentAnimation.anim2;
 ...
 */
public class MainActivityAnim2 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mian_fragment_anim2);

...
public class TestCustomAnimationActivity01 extends Activity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_custom_anim01);
    ...
    private void findViews() {
        ...
        final FlipAnimation fa = new FlipAnimation();
        fa.setDuration(1000);
        img4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                img4.startAnimation(fa);
            }
        });
    }

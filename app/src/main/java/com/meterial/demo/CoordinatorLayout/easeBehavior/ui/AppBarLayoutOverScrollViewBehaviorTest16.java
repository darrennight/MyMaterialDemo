 ...
 * toolbar背景变色 
 */ 
public class AppBarLayoutOverScrollViewBehaviorTest16 extends AppBarLayout.Behavior {
    ...
    public AppBarLayoutOverScrollViewBehaviorTest16() {
    }

    public AppBarLayoutOverScrollViewBehaviorTest16(Context context, AttributeSet attrs) {
        super(context, attrs);
    } 
...
//        middleLayout.setBottom(mLastBottom); 
    ...
    public void setOnProgressChangeListener(AppBarLayoutOverScrollViewBehaviorTest16.onProgressChangeListener onProgressChangeListener) {

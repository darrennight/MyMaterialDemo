...
/**
 *ToolBar可以滚动出去 下拉时先显示ToolBar 但是注意Toobar滑出一半松开会有弹性 类似Viewpager回弹
 * @author zenghao
 * @since 16/12/16 上午10:51
 */
public class TestActivity3 extends AppCompatActivity implements OnItemClick {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mToolbar = ((Toolbar) findViewById(R.id.toolbar_test3));
        mToolbar.setTitle("CoordinatorTest1");
        setSupportActionBar(mToolbar);

        mRecyclerView = ((RecyclerView) findViewById(R.id.rv_test3));

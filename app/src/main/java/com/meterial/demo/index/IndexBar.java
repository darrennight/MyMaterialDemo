...
class IndexBar extends View {
    ...
    public IndexBar(Context context) {
        super(context);
        setBackgroundResource(R.drawable.selector_stroke_roundredcir);
    } 
...
//            return; 
//        }
        int widthTest = MyUtils.dip2px(getContext(),23);
        super.onMeasure(widthTest, MeasureSpec.makeMeasureSpec(mTotalHeight, MeasureSpec.EXACTLY));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < mIndexList.size(); i++) {
            if (mSelectionPosition == i) {
                ...
                canvas.drawText(mIndexList.get(i), getWidth() / 2, mIndexHeight * 0.85f + mIndexHeight * (i+1), mFocusPaint);
                /*if(i == mIndexList.size()-1){
                    canvas.drawText("哈", getWidth() / 2, mIndexHeight * 0.85f + mIndexHeight * (i+2), mPaint);
                }*/
                ...
                canvas.drawText(mIndexList.get(i), getWidth() / 2, mIndexHeight * 0.85f + mIndexHeight * (i+1), mPaint);
                /*if(i == mIndexList.size()-1){
                    canvas.drawText("*", getWidth() / 2, mIndexHeight * 0.85f + mIndexHeight * (i+2), mPaint);
                }*/

            }
        }
       //canvas.drawText("*", getWidth() / 2, mIndexHeight * 0.85f + mIndexHeight * (mIndexList.size()+2), mPaint);
    ...
    int getPositionForPointY(float y) {
        ...
        int position = (int) (y / mIndexHeight)-1;
    ...
    void setSelection(int firstVisibleItemPosition) {
        if (mDatas == null
                || mDatas.size() <= firstVisibleItemPosition

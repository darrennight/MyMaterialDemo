...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        super(context, attrs);
        //style中的字段对应styleable
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.VerWheelView, 0, R.style.VerWheelView);
        //TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.VerWheelView, 0, 0);
        //是否循环
        boolean cyclic = a.getBoolean(R.styleable.VerWheelView_cyclic, false);
        //可以显示的item个数
        int visibleItems = a.getInt(R.styleable.VerWheelView_visibleItems, mVisibleItems);
        //行间距
        int lineSpace = a.getDimensionPixelOffset(R.styleable.VerWheelView_lineSpace, mLineSpace);
        //文字大小
        int textSize = a.getDimensionPixelSize(R.styleable.VerWheelView_wv_textSize, mTextSize);
        //选中颜色
        int selectedColor = a.getColor(R.styleable.VerWheelView_selectedColor, 0);
        //未选中颜色
        int unselectedColor = a.getColor(R.styleable.VerWheelView_unselectedColor, 0);
        mDividerTop = a.getDrawable(R.styleable.VerWheelView_divider);
        mDividerBottom = a.getDrawable(R.styleable.VerWheelView_divider);
        CharSequence[] entries = a.getTextArray(R.styleable.VerWheelView_entries);
        a.recycle();

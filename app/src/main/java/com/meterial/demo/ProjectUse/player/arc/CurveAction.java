package com.meterial.demo.ProjectUse.player.arc;
...
import com.meterial.demo.ProjectUse.player.BaseAction;
...
public class CurveAction extends BaseAction {
    ...
    public void animate(View view) {
        final ObjectAnimator anim = ObjectAnimator.ofObject(this, PATH_POINT_LOCATION,new PathEvaluator(), path.getPoints().toArray());
